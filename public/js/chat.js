...
const sidebarTempale = document.querySelector('#sidebar-template').innerHTML;
...
socket.on('locationMessage', (messageLocation) => {
  const html = Mustache.render(locationTemplate, {
    ...
    location: messageLocation.url,
    createdAt: moment(messageLocation.createdAt).format('hh:mm a'),
  });
...
socket.on('roomData', ({ room, users }) => {
  const html = Mustache.render(sidebarTempale, {
    room,
    users,
  });
